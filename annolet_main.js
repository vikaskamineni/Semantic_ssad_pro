...
{
    $j("body").append('<div id=\"search-wrap\" hidden> <ul class=\"annolet_dropdown\"><li><a href=\"#\">manual_modify</a> <ul class=\"sub-menu\"> <li><a href=\"#\" onclick=\"manual_modify(\'event-name\')\">Name</a></li> <li><a href=\"#\">Location</a> <ul><li><a href=\"#\" onclick=\"manual_modify(\'event-location-street\')\">Street</a></li> <li><a href=\"#\" onclick=\"manual_modify(\'event-location-area\')\">Area</a></li> <li><a href=\"#\" onclick=\"manual_modify(\'event-location-city\')\">City</a></li></ul></li> <li><a href=\"#\">Organisation</a> <ul><li><a href=\"#\" onclick=\"manual_modify(\'organisation-owner\')"\>Owner</a></li> <li><a href=\"#\" onclick=\"manual_modify(\'organisation-employee\')"\>Employee</a></li> <li><a href=\"#\" onclick=\"manual_modify(\'organisation-contact\')"\>Contact</a></li> <li><a href=\"#\">Location</a> <ul><li><a href=\"#\" onclick=\"manual_modify(\'event-location-street\')\">Street</a></li> <li><a href=\"#\" onclick=\"manual_modify(\'event-location-area\')\">Area</a></li> <li><a href=\"#\" onclick=\"manual_modify(\'event-location-city\')\">City</a></li></ul></li></ul></li></ul></li> <li><a href=\"#\">Search_modify</a> <ul class=\"sub_menu\"> <li> <a href=\"#\">Date</a><ul><li><a href=\"#\">startdate</a> <ul><li><a href=\"#\" onclick=\"modify_startdate_britishA()\">British-A</a></li> <li><a href=\"#\" onclick=\"modify_startdate_britishB()\">British-B</a></li> <li><a href=\"#\" onclick=\"modify_startdate_americanA()\">American-A</a></li> <li><a href=\"#\" onclick=\"modify_startdate_americanB()\">American-B</a></li> <li><a href=\"#\" onclick=\"modify_startdate_americanC()\">American-C</a></li> </ul></li> <li><a href=\"#\">enddate</a> <ul><li><a href=\"#\" onclick=\"modify_enddate_britishA()\">British-A</a></li> <li><a href=\"#\" onclick=\"modify_enddate_britishB()\">British-B</a></li> <li><a href=\"#\" onclick=\"modify_enddate_americanA()\">American-A</a></li> <li><a href=\"#\" onclick=\"modify_enddate_americanB()\">American-B</a></li> <li><a href=\"#\" onclick=\"modify_enddate_americanC()\">American-C</a></li></ul> </li></ul></li> <li><a href=\"#\">Unit</a><ul><li><a href=\"#\" onclick=modify_unit_SI>SI</a></li> <li><a href=\"#\" onclick=modify_unit_CGI>CGI</a></li> <li><a href=\"#\" onclick=modify_unit_FPS>FPS</a></li></ul></li> </ul></li></ul></div>');
